...
Promise.all = function (arrOfPromise) {
    var _this = this;
    var arr = [];
    var resolvePromiseCount = 0;
    return new Promise(function (resolve, reject) {
        try {
            arrOfPromise.forEach(function (element) { return __awaiter(_this, void 0, void 0, function () {
                var promiseOutput;
...
Promise.all([promise1, promise2, promise3, promise4]).then(function (arr) {
    console.log(arr);
});
